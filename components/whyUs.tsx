...
export const featuresList = [
  {
    ...
    desc: `We stand as one of the leading brands of Pakistan in islamic calligraphy art. `,
    icon: (
      <svg
  ...
  {
    id: 2,
    title: 'Free & Safe Home Delivery',
    desc: `We offer free home delivery all over Pakistan. All designs are shipped in durable packaging to ensure the guranteed safe delivery`,
    icon: (
      <svg
        style={{ width: '2rem', height: '2rem' }}
        viewBox="0 0 24 24"
  ...
  },
  {
    ...
    desc: ` We craft personalized designs tailored to your unique style and preferences for a truly distinctive touch in your space.`,
    icon: (
      <svg
        style={{ width: '2rem', height: '2rem' }}
        viewBox="0 0 24 24"
